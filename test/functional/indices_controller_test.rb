...
class IndicesControllerTest < ActionController::TestCase
  ...
  test "should create index" do
    assert_difference('Index.count') do
      post :create, index: { address: @index.address, date: @index.date, email: @index.email, name: @index.name, orderinfo: @index.orderinfo, phonenumber: @index.phonenumber }
    end
  ...
  test "should update index" do
    put :update, id: @index, index: { address: @index.address, date: @index.date, email: @index.email, name: @index.name, orderinfo: @index.orderinfo, phonenumber: @index.phonenumber }
    assert_redirected_to index_path(assigns(:index))
  end
